...
const char* ssid = "stemcamp2";
const char* password = "";
String robotname = "BIGROBOT";
const char * regserverIP = "192.168.8.181";
...
void setup() {
  ...
  Serial.print("Connecting to RegIP Server...");
  // Use WiFiClient class to create TCP connections
    WiFiClient client;
client.connect(regserverIP, regserverPort);

    while(true){
      if (!client.connect(regserverIP, regserverPort)) {
  ...
  {
    Serial.println("client.available() timed out, please press reset on the robot.");
  }
